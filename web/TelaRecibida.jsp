        ...
        <div class="container" id="ocultarlistarclientes">
                            ...
                            <table class="table table-hover" id="dev-table">
                                ...
                                <tbody>
                                    <tr class="padre">
                                        ...
                                        <td>
                                            <select class="form-control" style="height: 32px;" name="cliente" id="cliente">
            ...
            <form method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <table class="table table-hover" id="dev-table">
                                ...
                                <tbody class="TelaRecibida" id="TelaRecibida">
                ...
                <div class="row ">
                    ...
                    <div class="col-xs-12 col-md-12"><a href="TelasEnBodega.jsp" class="btn btn-success btn-block btn-lg">Telas Almacenadas</a></div>
                </div>
            </form>
