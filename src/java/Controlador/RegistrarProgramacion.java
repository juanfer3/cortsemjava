...
import Modelo.ProgramacionDetallada;
 ...
 * @author Juan
 */
@WebServlet(name = "RegistrarProgramacion", urlPatterns = {"/RegistrarProgramacion"})
public class RegistrarProgramacion extends HttpServlet {
